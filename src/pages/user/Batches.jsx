...
function JoinedBatchDetail({ batch, myAttempts, currentUser, currentUserName, onBack }) {
  ...
  return (
    <div className="h-screen bg-gray-950 text-white flex flex-col overflow-hidden">
      <Navbar />
      <div className="flex-1 overflow-hidden max-w-7xl mx-auto w-full px-3 sm:px-6 pt-3 flex flex-col min-h-0 pb-16 sm:pb-0">
...
export default function Batches() {
  ...
  if (loading) return (
    <div className="min-h-screen bg-gray-950 text-white">
      <Navbar />
      <div className="max-w-7xl mx-auto px-3 sm:px-6 py-6 sm:py-8 pb-24 sm:pb-8">
